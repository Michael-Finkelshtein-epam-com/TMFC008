...
@JsonTypeInfo(
    ...
    visible = true)
    @JsonSubTypes({
@Type(value=ListServiceSuccess.class),
...
public abstract interface OneOfListServiceSuccessBadRequestResponseUnauthorizedResponseForbiddenResponseNotFoundResponseMethodNotAllowedResponseConflictResponseInternalServerErrorResponse {
}