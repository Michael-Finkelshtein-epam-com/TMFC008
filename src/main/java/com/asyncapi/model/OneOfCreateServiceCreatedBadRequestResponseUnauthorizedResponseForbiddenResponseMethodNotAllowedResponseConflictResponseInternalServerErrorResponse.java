...
@JsonTypeInfo(
    ...
    visible = true)
    @JsonSubTypes({
@Type(value=CreateServiceCreated.class),
...
public abstract interface OneOfCreateServiceCreatedBadRequestResponseUnauthorizedResponseForbiddenResponseMethodNotAllowedResponseConflictResponseInternalServerErrorResponse {
}