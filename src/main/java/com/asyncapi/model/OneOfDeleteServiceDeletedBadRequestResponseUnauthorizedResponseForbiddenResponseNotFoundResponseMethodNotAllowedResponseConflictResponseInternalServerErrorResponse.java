...
@JsonTypeInfo(
    ...
    visible = true)
    @JsonSubTypes({
@Type(value=DeleteServiceDeleted.class),
...
public abstract interface OneOfDeleteServiceDeletedBadRequestResponseUnauthorizedResponseForbiddenResponseNotFoundResponseMethodNotAllowedResponseConflictResponseInternalServerErrorResponse {
}